   ...
   <!-- Register -->
    <form @submit.prevent="register" class="p-8 flex flex-col bg-light-grey rounded-md shadow-lg">
       ...
       <div class="flex flex-col mb-2">
        ...
        border-2 border-transparent hover:border-at-light-green hover:bg-white hover:text-at-light-green">Register</button>
...
export default {
  ...
  setup() {
    ...
    const register = async() => {
      ...
      errorMsg.value = "Error: password doesn't match"
      setTimeout(()=>{
         errorMsg.value = null;
      },5000)
    };
